...
public class Destinations extends JFrame implements Runnable{
    ...
    Destinations(){
        ...
        //As our Destination Image was in Jpg,Png,Jepg type stored so we have made Ext[] strings;
        String[] ext={"jpg","png","jpg","jpg","jpg","jpg","jpeg","jpg","jpg","jpg"};
        //Dinamically setting Image using loop
        for (int i=0;i<=9;i++) {
            image[i] = new ImageIcon(ClassLoader.getSystemResource("Icons_Travels/dest"+(i+1)+"."+ext[i]));
